    ...
    <aside className="hidden w-[260px] shrink-0 border-r border-slate-200 bg-white lg:block">
      <div className="flex h-full flex-col">
        <div className="flex items-center gap-3 px-5 py-5">
          ...
          <div>
            <div className="text-base font-semibold leading-tight">ClinTrust</div>
            <div className="text-xs text-slate-500">Clinical Trial Management</div>
          </div>
        </div>
        ...
        <div className="border-t border-slate-200 p-4">
          <div className="rounded-xl bg-slate-50 p-4 text-xs text-slate-600 ring-1 ring-slate-100">
